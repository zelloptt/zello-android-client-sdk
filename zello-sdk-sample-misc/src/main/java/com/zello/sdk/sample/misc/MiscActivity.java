...
public class MiscActivity extends Activity implements com.zello.sdk.Events {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		_lockButton = (Button)findViewById(R.id.lockButton);
		_statusTextView = (TextView)findViewById(R.id.statusTextView);
		_externalIdEditText = (EditText)findViewById(R.id.externalIdEditText);
		_externalIdTextView = (TextView)findViewById(R.id.externalIdTextView);
